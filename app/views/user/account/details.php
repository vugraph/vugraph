...
echo Form::_fieldsetOpen(trans('user/account/details.title'));
echo Form::_messages($errors->all());
echo Form::_row(
	Form::_label('first_name', trans('user/account/details.first_name')),
	Form::_input('text', 'first_name', null, array('required' => 'required', 'maxlength' => '30', 'pattern' => '.{2,30}'))
);
echo Form::_row(
	Form::_label('last_name', trans('user/account/details.last_name')),
	Form::_input('text', 'last_name', null, array('required' => 'required', 'maxlength' => '30', 'pattern' => '.{2,30}'))
);
echo Form::_row(
	Form::_label('email', trans('user/account/details.email')),
