...
echo Form::_row(
	...
	Form::_help(trans('auth/register.password_help')),
	 'password');
echo Form::_row(
	Form::_label('password_confirmation', trans('auth/register.password_confirmation')),
