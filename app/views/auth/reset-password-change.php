...
echo Form::_row(
	Form::_label('password', trans('auth/reset-password.labels.password')),
...
echo Form::_row(
	Form::_label('password_confirmation', trans('auth/reset-password.labels.password_confirmation')),
