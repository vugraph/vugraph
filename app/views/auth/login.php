...
echo Form::_row(Form::_label('email', trans('auth/login.email')),
	 Form::_input('email', 'email', null, array('required' => 'required', 'maxlength' => '100')));
echo Form::_row(Form::_label('password', trans('auth/login.password')),
...
echo Form::_row('', link_to('reset-password', trans('auth/login.forgot_password')));
